            ...
            protected void populateViewHolder(final RequestViewHolder viewHolder, Requests model, final int position) {
                ...
                get_type_ref.addValueEventListener(new ValueEventListener() {
                    ...
                    if(dataSnapshot.exists()){
                        ...
                        if(request_type.equals("sent")){mUsersDatabase.child(list_user_id).addValueEventListener(new ValueEventListener() {
                        ...
                        else if(request_type.equals("received")){mUsersDatabase.child(list_user_id).addValueEventListener(new ValueEventListener() {
